...
public class BluetoothConnectionServices {
...
//    ProgressDialog mProgressDialog;
    ...
    public BluetoothConnectionServices(Context context) {
        mContext = context;
    ...
    private class ConnectThread extends Thread {
        ...
        public void run(){
            ...
            try {
                ...
                // successful connection or an exception
                mmSocket.connect();
                //Toast.makeText(mContext,mmDevice.getName()+" Connected",Toast.LENGTH_SHORT).show();
            } catch (IOException e) {
                // Close the socket
                try {
                    mmSocket.close();
        ...
        public void run(){
            ...
            while (true) {
                ...
                try {
                    ...
                    Intent incomingMessageIntent = new Intent("TheIncomingMessege");
